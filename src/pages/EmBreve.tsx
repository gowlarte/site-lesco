...
const linhasInfo: Record<string, { nome: string; descricao: string }> = {
  zhuzen: { nome: "Zhú", descricao: "Revestimentos, forros e decorativos em bambu." },
  echotex: { nome: "Echo", descricao: "Tecido acústico moldado para estúdios e home cinemas." },
  italflex: { nome: "Geo", descricao: "Revestimento flexível para fachadas e ambientes internos." },
