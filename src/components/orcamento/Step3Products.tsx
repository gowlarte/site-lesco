...
const Step3Products = ({ data, onChange, errors }: Step3Props) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <label className="block font-display text-[11px] tracking-wider uppercase text-dark/50 mb-3">
          Produtos de interesse * <span className="normal-case text-dark/40">(selecione ao menos 1)</span>
        </label>
