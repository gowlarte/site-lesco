    ...
    <div className="space-y-6">
      <div>
        ...
        <select
          ...
          className={`w-full bg-white/60 border ${errors.timeline ? "border-red-400" : "border-primary/10"} rounded-[10px] px-4 py-3.5 font-body text-[15px] text-dark focus:outline-none focus:border-primary/30 transition-colors appearance-none`}
        >
      ...
      <div>
        <label className="block font-display text-[11px] tracking-wider uppercase mb-3 text-muted-foreground">
          Produtos de interesse * <span className="normal-case text-primary/65">(selecione ao menos 1)</span>
        </label>
              ...
              <div
                ...
                className={`flex items-center gap-3 p-3.5 rounded-[10px] border cursor-pointer transition-all ${
                  isChecked
                    ...
                    : "border-primary/10 bg-white/60 hover:border-primary/20"
                }`}
              >
                <div
                  className={`w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all ${
                    isChecked ? "bg-dark border-dark" : "border-primary/20"
                  }`}
                >
                  {isChecked && (
